...
public class Example extends ChaincodeBase {
	...
	public String run(ChaincodeStub stub, String function, String[] args) {
		log.info("Step 3 - In run, function:"+function);
		switch (function) {
		case "put":
	...
	public String query(ChaincodeStub stub, String function, String[] args) {
		log.info("Step 5 - query");
		log.info("Step 6 - Hello world! function:"+function);
		log.info("Step 7 - query:"+args[0]+"="+stub.getState(args[0]));
		if (stub.getState(args[0])!=null&&!stub.getState(args[0]).isEmpty()){
			log.info("Step 7.1 - returning: Hello world! from "+ stub.getState(args[0]));
	...
	public static void main(String[] args) throws Exception {
		log.info("Step 1 - Hello world! starting "+args);
		log.info("Step 2 - starting");
